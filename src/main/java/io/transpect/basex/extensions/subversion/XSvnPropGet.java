...
public class XSvnPropGet {
  ...
  */
  public FNode XSvnPropGet (String url, String username, String password, String property, String revision) {
    ...
    try{
      ...
      if(propData != null){
        ...
        return XSvnXmlReport.createXmlError(msg);
      }
	...
	public FNode XSvnPropGet (String url, XQMap auth, String property, String revision) {
    SVNRevision svnRevision, svnPegRevision;
    SVNPropertyData propData;
    try{
      if(revision.trim().isEmpty()){
